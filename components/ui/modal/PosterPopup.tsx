...
export default function PosterPopup() {
    ...
    const newWindow = () => {
        window.open('/assets/images/poster/amcamp_online_poster.jpg', '_blank')
    }

    if (!isShow || !isCookieChecked) return null
    return (
        <div className='absolute inset-0 flex items-center justify-center z-[990]'>
            <div className='absolute w-[360px] md:w-[500px] lg:w-[580px] top-[80px] lg:top-[100px] border bg-white rounded-lg z-[990]'>
                <Image src='/assets/images/poster/amcamp_online_poster.jpg' alt='포스터 이미지' width={650} height={800} onClick={newWindow} className='cursor-pointer' quality={100} />
                <div className='flex'>
