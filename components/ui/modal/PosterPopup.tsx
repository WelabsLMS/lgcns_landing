...
export default function PosterPopup() {
    ...
    return (
        <div className='absolute md:left-1/4 lg: lg:left-1/3 border bg-white rounded-lg z-[990]'>
            <Image src='/assets/images/poster/LGCNS_AM_POSTER.svg' alt='포스터 이미지' width={600} height={800} onClick={newWindow} className='cursor-pointer'/>
            <div className='flex'>
