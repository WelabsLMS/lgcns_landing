...
function Header() {
    ...
    return (
        <>
            <header className='w-full sticky top-0 left-0 bg-white border-b-[1px] border-gray-200 z-[99999] lg:px-40 h-[80px] lg:h-[100px] flex items-center'>
                <div className='h-min container mx-auto py-5 flex-row justify-between hidden lg:flex'>
                ...
                <div className={`absolute top-[80px] bg-white w-full h-max flex flex-col items-center py-4 lg:hidden transition-all duration-500 transform ${subMenuOpen ? 'scale-y-100 opacity-100' : 'scale-y-0 opacity-0'} origin-top`}>
                    <ul className='text-center flex flex-col gap-3 text-xl font-bold cursor-pointer'>
                        ...
                        <li className='text-white rounded-2xl px-4 py-[1px] bg-gradient-to-r from-[#E2275488] to-[#FFD028] drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] font-semibold'>
                            <Link href={'https://wsts.kr'}>LMS</Link>
                        </li>
                        <li className='text-white rounded-2xl px-4 py-[1px] bg-gradient-to-r from-[#E2275488] to-[#FFD028] drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] font-semibold'>
                            <Link href={'/apply'}>수강신청</Link>
