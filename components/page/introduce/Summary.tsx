        ...
        <div className='mt-10 rounded-[30px] px-2 py-3 flex flex-col items-center bg-[#E0E9FF]'>
            ...
            <ol className='lg:list-disc flex flex-col items-center text-center lg:text-start lg:items-start lg:px-12 text-base md:text-xl lg:text-2xl font-medium bg-white rounded-[30px] w-full py-5'>
                <li className='mb-4'>
                    ...
                    <p className='leading-relaxed'>실무에 필요한 AM 기술 역량을 확보할 수 있도록 <br /> 풀스택 개발부터 전문성을 갖추기 위한 <br className='md:hidden'/> Agile, MSA, DevOps 영역의 실습 위주 <br className='hidden'/>교육</p>
                </li>
                <li>
