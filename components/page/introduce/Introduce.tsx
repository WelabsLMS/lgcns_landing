        ...
        <section id="introduce" className="section">
            ...
            <div className='container lg:px-28'>
                <div className='text-center'>
                    <p className='mb-2 text-3xl md:text-4xl font-bold text-nowrap'>LG CNS의 <br className='lg:hidden' /> SW, AM<span className='text-base md:text-2xl'>(Application Modernization)</span><br className='xl:hidden' /> 인재 육성 노하우를 그대로 적용한</p>
