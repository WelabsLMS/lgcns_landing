        ...
        <section id="introduce" className="section">
            ...
            <div className='container lg:px-28'>
                <div className='text-center'>
                    <p className='mb-2 text-2xl md:text-3xl font-bold text-nowrap'>LG CNS의 <br className='lg:hidden' /> SW, AM<span className='text-base md:text-2xl'>(Application Modernization)</span>
