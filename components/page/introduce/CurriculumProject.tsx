            ...
            <div className='text-center my-10 md:my-20'>
                ...
                <div className='md:text-2xl font-semibold my-10 w-max flex flex-col items-center mx-auto'>
                    <div className='relative'>
                        <Image className='absolute -top-2 -left-5 w-3 md:w-4' src='assets/images/curriculum/quotes_left.svg' alt='curriculum' width={15} height={25} />
                        AM 전문가로 성장하기 위한 첫 걸음
                    </div>
                    <div className='relative'>
                        실무 경험이 풍부한 실무 전문가에게 배우세요!
                        <Image className='absolute -bottom-2 -right-5 w-3 md:w-4' src='assets/images/curriculum/quotes_right.svg' alt='curriculum' width={15} height={25} />
                    </div>
                </div>
            </div>
            <div className='flex flex-col lg:flex-row justify-center gap-10 h-auto lg:h-96'>
                <div className='w-full lg:w-2/5 flex lg:flex-col gap-5 h-full text-center lg:text-start'>
                ...
                <div className='flex h-[50vh] xl:h-full w-full lg:w-2/5 rounded-2xl border'>
                    <Swiper
                        slidesPerView={1}
                        direction='vertical'
                        modules={[Navigation]}
