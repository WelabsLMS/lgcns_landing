        ...
        <section className="section">
            ...
            <div className='container mx-auto'>
                <div className='flex flex-col md:flex-col justify-center'>
                    <div className='text-xl lg:text-[28px] text-center mb-0 md:mt-10 md:mb-5'>
                ...
                <div className='flex flex-col md:flex-col justify-center'>
                    <div className='text-2xl lg:text-3xl text-center mt-10 leading-9'>
                        <p className='text-[#002278] font-bold'>오프라인 교육장</p>
                    </div>
                    <div className='flex flex-col gap-4 md:gap-0 md:flex-row justify-center'>
                        {
                            centerImagesData.LG.map((image) => (
                                <CampImageEle key={image.id} img={image.img} title={image.title} /> 
                            ))
                        }
                    </div>
                </div>
