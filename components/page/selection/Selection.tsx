    ...
    return (
        <section className="section">
            ...
            <div className='container mx-auto'>
                <div className='flex flex-wrap sm:flex-row justify-center items-center lg:gap-12 md:gap-4 mb-24'>
                    {
                ...
                <div className='text-center font-semibold px-4 lg:px-10 xl:px-40 text-lg md:text-xl'>
