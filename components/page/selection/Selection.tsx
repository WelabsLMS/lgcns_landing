    ...
    return (
        <section className="section">
            ...
            <div className='container mx-auto'>
                <div className='flex flex-wrap sm:flex-row justify-center items-center lg:gap-12 md:gap-4 my-4 md:my-16'>
                    {
                ...
                <div className='px-4 lg:px-10 xl:px-40 text-lg md:text-xl'>
