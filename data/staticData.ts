    ...
    [
        {
            ...
            answer: '<p>내일배움카드 발급이 가능하며, 국내외 대학(원) 졸업(예정)자 및 미취업자라면 모두 지원할 수 있습니다.</p><p> 나이, 학력 및 전공 제한없이 모두 지원 가능합니다.</p>',
        },
        {
            question: '내일배움카드가 있어야 교육을 받을 수 있나요?',
            answer: '<p>해당 교육과정은 KDT 과정으로 교육 입과 전 내일배움카드를 발급 받으셔야 수강이 가능합니다.</p> <p>자세한 발급 방법은 고용노동부(1350) 또는 직업훈련포털(www.work24.go.kr)에서 확인해주세요.</p>',
        },
        {
            question: '비전공자도 지원 가능할까요?',
            answer: '<p>프로그래밍 관련 경험이 있다면 비전공자도 지원 가능합니다.</p><p>교육에 대한 의지와 성장 가능성 있는 지원자를 선발하므로 지원서에 상세히 기입해주시기 바랍니다.</p>',
        },
        {
            question: '국민취업지원제도와 병행 가능한가요?',
            answer: '<p>국민취업지원제도와 KDT 과정은 병행 가능합니다. </p><p>고용센터 담당자와 상담 후 수강 신청 가능하므로 빠른 신청을 권장합니다.</p>',
        },
        {
